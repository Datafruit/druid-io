...
Historical 节点配置
=============================
一般的Historical 节点信息，查阅[这里](../design/historical.html)。
Runtime Configuration
---------------------

Historical节点使用的几个全球配置在[配置](../configuration/index.html)和还有下面的配置设置：
### 节点配置
...
你可以通过设置缓存配置在Historical上只选择启动配置缓存。
...
查阅[缓存配置](caching.html)了解怎么配置缓存设置。